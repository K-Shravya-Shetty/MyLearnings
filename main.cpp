...
public:
    float **X;            // input
    float *y;             // output
    int number_predictor; // number of input columns
    ...
    Dataset(const char *filename)
    {
        ...
        // First pass : count rows and predictors
...
// class to store weights and updated weights
class Weights
{
private:
    int MAX_WEIGHTS;
...
public:
    ...
    // calculate gradient for one weight
